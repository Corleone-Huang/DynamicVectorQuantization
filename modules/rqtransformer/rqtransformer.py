...
from modules.rqtransformer.attentions import AttentionBlock
from modules.rqtransformer.utils import sample_from_logits

class RQTransformer(pl.LightningModule):
    def __init__(self, 
                 vocab_size_cond,
                 vocab_size,
                 block_size_cond,
