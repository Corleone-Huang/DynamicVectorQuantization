...
class TripleGrainEncoder(pl.LightningModule):
    def __init__(self, 
        ...
        **ignore_kwargs
        ...
        self.router = TripleGrainRouter(**router_config)
    ...
    def forward(self, x):
        ...
        gate = self.router(h_fine=h_fine, h_median=h_median, h_coarse=h_coarse)
        if self.training:
...
class TripleGrainRouter(nn.Module):
    ...
    def forward(self, h_fine, h_median, h_coarse):
...
if __name__ == "__main__":
    ...
    encoder = TripleGrainEncoder(
        ...
        resolution=256, 
        z_channels=256, 
        router_config={"num_channels": 256},
    )
