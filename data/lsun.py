...
class LSUNClass(torchvision.datasets.VisionDataset):
    ...
    def __init__(self, root=Path(__file__).parent.joinpath('LSUN'), 
                 category_name='church', resolution = 256):
...
if __name__ == "__main__":
    church_train = LSUNClass(root="data/LSUN/", category_name='cat')
    print(len(church_train))