...
import torchvision
from data.medical_datasets.KaggleLung import KaggleLungDataset
...
if __name__ == "__main__":
    ...
    dataset = KaggleLungDataset(
        resolution=256, flip_p=0.5, is_eval=False, normalize=False, with_mask=True, dataset_expand=1000
    )
