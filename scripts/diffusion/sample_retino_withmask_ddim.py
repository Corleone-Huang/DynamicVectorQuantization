...
if __name__ == "__main__":
    ...
    save_path = opt.model_path.replace(".ckpt", "") + "_" + now + "_steps-{}_".format(opt.timestep_respacing)
    ...
    if opt.timestep_respacing is not "":
        ...
        configs["model"]["params"]["diffusion_config"]["rescale_timesteps"] = True
    # model
